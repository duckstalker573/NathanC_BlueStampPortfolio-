...
# Code
This is the code for the Biometric Attendacne without Modifications 
...
<summary>Code for Funtions (Delete, Enroll, Attendance) </summary>

```c++
//Searches the Database for Existing Fingerprints
int getFingerprintIDez()
{
  uint8_t p = finger.getImage(); // Capture fingerprint image
  if (p != FINGERPRINT_OK)
